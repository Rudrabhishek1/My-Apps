      ...
      <div onClick={(e) => e.stopPropagation()} className="w-full max-w-3xl max-h-[90vh] overflow-hidden flex flex-col">
        <Card className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="space-y-4 overflow-y-auto custom-scrollbar pr-2 -mr-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            <p><strong>User-Provided Content:</strong> The exam configuration, questions, and answers you provide are sent directly from your browser to the Google Gemini API to generate your evaluation. This data is not sent to, stored on, or logged by our servers.</p>
            <p><strong>API Keys:</strong> This application is powered by the Google Gemini API. You are required to provide your own Google Gemini API key. This key is stored exclusively in your browser's `localStorage` and is only used to make requests from your browser to the Google Gemini API. It is never sent to our servers.</p>
